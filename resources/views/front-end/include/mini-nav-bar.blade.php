<div class="offcanvas offcanvas-start d-flex d-lg-none" tabindex="-1" id="drawer-menu" align="left">
                   ...
                   @if(Session::get('customerId'))
                    <li class="utilty-menu-item">
                        <button type="button" class="currency-btn btn-reset" data-bs-toggle="dropdown"
                            ...
                            <span>{{Session::get('customerName')}}</span>
                            <span class="utilty-icon-wrapper">
                                    <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <ul class="currency-list dropdown-menu dropdown-menu-end px-4">
                            ...
                            <li class="currency-list-item ">
                                <a class="currency-list-option" href="{{route('customer.logout')}}" data-value="CAD">
                                    <img class="flag" src="{{asset('/')}}/front-end/assets/img/logout.jpg" alt="img">
                                    <span>Logout</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    @else
                    <li class="utilty-menu-item">
                        <a class="announcement-login announcement-text" href="{{route('customer.login')}}">
                                <span class="utilty-icon-wrapper">
                                    <svg class="icon icon-user" width="24" height="24" viewBox="0 0 10 11" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
