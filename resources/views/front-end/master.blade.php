                ...
                <ul class="utility-menu list-unstyled">
                    ...
                    <li class="utilty-menu-item">
                        <button type="button" class="currency-btn btn-reset" data-bs-toggle="dropdown"
                                aria-expanded="false">
                            <img class="flag" src="{{asset('/')}}/front-end/assets/img/flag/usd.jpg" alt="img">
                            <span>USD</span>
                            <span class="utilty-icon-wrapper">
                                    <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <ul class="currency-list dropdown-menu dropdown-menu-end px-2">
                            ...
                            <li class="currency-list-item ">
                                <a class="currency-list-option" href="#" data-value="CAD">
                                    <img class="flag" src="{{asset('/')}}/front-end/assets/img/flag/cad.jpg" alt="img">
                                    <span>CAD</span>
                                </a>
                            </li>
                            <li class="currency-list-item ">
                                <a class="currency-list-option" href="#" data-value="EUR">
                                    <img class="flag" src="{{asset('/')}}/front-end/assets/img/flag/eur.jpg" alt="img">
                                    <span>EUR</span>
                                </a>
                            </li>
                            <li class="currency-list-item ">
                                <a class="currency-list-option" href="#" data-value="JPY">
                                    <img class="flag" src="{{asset('/')}}/front-end/assets/img/flag/jpy.jpg" alt="img">
                                    <span>JPY</span>
                                </a>
                            </li>
                            <li class="currency-list-item ">
                                <a class="currency-list-option" href="#" data-value="GBP">
                                    <img class="flag" src="{{asset('/')}}/front-end/assets/img/flag/gbp.jpg" alt="img">
                                    <span>GBP</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    @foreach(ShoppingCart::all() as $product)
                        <div class="minicart-item d-flex">
                            ...
                            <div class="product-info">
                                ...
                                <p class="product-vendor">{{$product->qty}}x{{$product->price}}</p>
                                ...
                                <div class="product-img-large">
                                    <div class="qv-large-slider img-large-slider common-slider" data-slick='{
                                        ...
                                        <div class="img-large-wrapper">
                                            <img src="{{asset('/')}}/front-end/assets/img/products/bags/39.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{asset('/')}}/front-end/assets/img/products/bags/38.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{asset('/')}}/front-end/assets/img/products/bags/37.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{asset('/')}}/front-end/assets/img/products/bags/36.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{asset('/')}}/front-end/assets/img/products/bags/34.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{asset('/')}}/front-end/assets/img/products/bags/30.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{asset('/')}}/front-end/assets/img/products/bags/32.jpg" alt="img">
                                        </div>
                                    </div>
                                </div>
...
<!-- Mirrored from spreethemesprevious.github.io/bisum/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jun 2023 07:46:39 GMT -->
</html>
