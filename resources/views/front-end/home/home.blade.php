                ...
                <div class="row">
                        ...
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/9.jpg"
                                         alt="product-img">
                                    <img class="primary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/1.jpg"
                                         alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/10.jpg"
                                         alt="product-img">
                                    <img class="primary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/2.jpg"
                                         alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/11.jpg"
                                         alt="product-img">
                                    <img class="primary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/3.jpg"
                                         alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/14.jpg"
                                         alt="product-img">
                                    <img class="primary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/4.jpg"
                                         alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/15.jpg"
                                         alt="product-img">
                                    <img class="primary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/5.jpg"
                                         alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/16.jpg"
                                         alt="product-img">
                                    <img class="primary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/6.jpg"
                                         alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/17.jpg"
                                         alt="product-img">
                                    <img class="primary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/7.jpg"
                                         alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/19.jpg"
                                         alt="product-img">
                                    <img class="primary-img" src="{{asset('/')}}/front-end/assets/img/products/furniture/8.jpg"
                                         alt="product-img">
                                </a>
                ...
                <div class="article-card-container position-relative">
                    <div class="common-slider" data-slick='{
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="article.html">
                                    <img src="{{asset('/')}}/front-end/assets/img/blog/furniture-1.jpg" alt="img"
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="article.html">
                                    <img src="{{asset('/')}}/front-end/assets/img/blog/furniture-2.jpg" alt="img"
                                         class="article-card-img rounded">
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="article.html">
                                    <img src="{{asset('/')}}/front-end/assets/img/blog/furniture-3.jpg" alt="img"
                                         class="article-card-img rounded">
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="article.html">
                                    <img src="{{asset('/')}}/front-end/assets/img/blog/furniture-4.jpg" alt="img"
                                         class="article-card-img rounded">
                                    <span class="article-tag article-tag-absolute rounded">Furniture</span>
                                </a>
                                <p class="article-card-published text_12 d-flex align-items-center">
