    ...
    <div class="breadcrumb">
        <div class="container">
            <ul class="list-unstyled d-flex align-items-center m-0">
                ...
                <li>Sub-Category Based Products</li>
            </ul>
        </div>
    </div>
    <!-- breadcrumb end -->
                        ...
                        <div class="collection-product-container">
                            <div class="row">
                                @foreach($products as $product)
                                    <div class="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700" align="left">
                                        <div class="product-card">
                                            <div class="product-card-img">
                                                ...
                                                <div class="product-badge">
                                                    <span class="badge-label badge-percentage rounded">{{$product->subcategory->name}}</span>
                                                </div>
                                            ...
                                            <div class="product-card-details">
                                                ...
                                                <div class="product-card-price">
                                                    ...
                                                    <span
                                                        class="card-price-compare text-decoration-line-through">{{$product->regular_price}} TK</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
