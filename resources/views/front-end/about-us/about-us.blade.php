                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="about-hero-img">
                                <img src="{{asset('/')}}front-end/assets/img/about/about-hero.jpg" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-0 justify-content-center">
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="300">
                        <div class="promotional-item overlay-blue">
                            <img src="{{asset('/')}}front-end/assets/img/about/p1.jpg" alt="img">
                    ...
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="700">
                        <div class="promotional-item overlay-black">
                            <img src="{{asset('/')}}front-end/assets/img/about/p2.jpg" alt="img">
                            <div class="promotional-absolute">
                                <div class="promotional-content text-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="1000">
                        <div class="promotional-item overlay-yellow">
                            <img src="{{asset('/')}}front-end/assets/img/about/p3.jpg" alt="img">
                            <div class="promotional-absolute">
                                <div class="promotional-content text-center">
                        ...
                        <div class="team-wrapper">
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="team-item">
                                        <img src="{{asset('/')}}front-end/assets/img/team/1.jpg" alt="img">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="team-item">
                                        <img src="{{asset('/')}}front-end/assets/img/team/2.jpg" alt="img">
                                        <div class="member-absolute">
                                            <div class="member-details text-center">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="team-item">
                                        <img src="{{asset('/')}}front-end/assets/img/team/3.jpg" alt="img">
                                        <div class="member-absolute">
                                            <div class="member-details text-center">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="team-item">
                                        <img src="{{asset('/')}}front-end/assets/img/team/4.jpg" alt="img">
                                        <div class="member-absolute">
                                            <div class="member-details text-center">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="team-item">
                                        <img src="{{asset('/')}}front-end/assets/img/team/5.jpg" alt="img">
                                        <div class="member-absolute">
                                            <div class="member-details text-center">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="team-item">
                                        <img src="{{asset('/')}}front-end/assets/img/team/6.jpg" alt="img">
                                        <div class="member-absolute">
                                            <div class="member-details text-center">
