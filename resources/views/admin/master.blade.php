...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Jun 2023 15:50:37 GMT -->
<head>
    <!--  Title -->
    <title>
        @yield('title')
...
<div class="page-wrapper" id="main-wrapper" data-theme="blue_theme"  data-layout="vertical" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
   @include('admin.include.side-nav-bar')
    ...
    <div class="body-wrapper">
        ...
        <!--  Header End -->
        <main class="py-9" style="padding: 0 50px;">
            <div class="row pt-5">
                <div class="col-lg-12">
                    @yield('content')
                </div>
...
{{--            <img src="{{asset('/')}}/admin/dist/images/logos/favicon.png" alt="" class="img-fluid">--}}
